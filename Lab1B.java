...
public class Lab1B {
	...
	Lab1B(String name,String phno,String branch){
		this.name = name;
		this.phno = phno;
		this.branch = branch;
	}
	Lab1B(String name,String addr,String phno,String email,String branch){
		this.name = name;
		this.addr = addr;
		this.phno = phno;
		this.email = email;
	...
	public static void main(String[] args) {
		...
		Lab1B o2 = new Lab1B(name,phno,branch);
		
		Lab1B o3 = new Lab1B(name, addr, phno, email, branch);
