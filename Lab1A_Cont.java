...
public class Lab1A_Cont {
	...
	Lab1A_Cont(String name, String addr, String phno, String email, String branch) {
		this();
		this.name = name;
		this.addr = addr;
		this.phno = phno;
	...
	public static void main(String[] args) {
		...
		Lab1A_Cont s1 = new Lab1A_Cont(name,addr,phno,email,branch);
