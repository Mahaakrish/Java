...
public class Lab3A_Cont {
	...
	void m7(Connection con,String name,String deg) {
		try {
			Statement st = con.createStatement();
			ResultSet rs = st.executeQuery("select * from student where name='"+name+"' and degree='"+deg+"';");
			System.out.println("Data with name and degree...");
			while(rs.next()) {
				System.out.println("USN: "+rs.getInt(1));
				System.out.println("Name: "+rs.getString(2));
				System.out.println("Age: "+rs.getInt(3));
